...
<head>
    ...
    <title>SIDALANG | @yield('title')</title>
...
<body class="vh-100">
    ...
    <div id="preloader">
        <div class="waviy">
            <img src="{{asset('images/logosidalang.png')}}" class="d-block" alt=""  width="350" height="150" >
        ...
        <div id="main-wrapper">
            ...
            <div class="nav-header">
                <a href="index.html" class="brand-logo">
                    ...
                    <image class="brand-title" width="200px" height="100px" src="{{ asset('images/logo/text.svg') }}">
            ...
            <div class="dlabnav">
                <div class="dlabnav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li><a href="{{ route('bank_sampah.index') }}" class="ai-icon" aria-expanded="false">
                                <i class="flaticon-381-location-2"></i>
                                <span class="nav-text">Bank Sampah</span>
                            </a>
                        </li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                ...
                                <span class="nav-text">Master Sampah</span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="{{ route('sampah.index') }}">Sampah</a></li>
                                <li><a href="{{ route('jenis_sampah.index') }}">Jenis sampah</a></li>
                            </ul>
                        </li>
                        <li><a href="..." class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-repeat-1"></i>
                            <span class="nav-text">Penukaran</span>
                        </a>
                        </li>
                    </ul>
                </div>
